...
- United Nations ISO3 codes (FRA for France, GBR for Britain, etc.) were the backbone of our dataset, allowing us to associate terms (e.g. we linked "China","Chinese","PRC",  and "People's Republic of China", to the ISO3 code "CHN")

- Naturally, there were some complications; most notably, "Indian" frequently referred to Native Americans, which we were able to partially mitigate from Category context (e.g. "Colonial America", "Native Americans"). 

- Another interesting wrinkle was words like "French" and "Dutch", which are both an adjective and a demonym, being double-counted, briefly making France appear to be the most popular country in Jeopardy history. 
